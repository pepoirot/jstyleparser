...
import static test.DataUtil.getFile;
...
public class ImportTest {
	private static Logger log = LoggerFactory.getLogger(ImportTest.class);
	...
	public static void init() throws SAXException, IOException {
        ...
        DOMSource ds = new DOMSource(getStream("/data/simple/data.html"));
        doc = ds.parse();
	}
	...
	public void testSimpleImport() throws CSSException, IOException {
		...
		StyleSheet ss = CSSFactory.parse(getFile("/data/simple/imp.css"), null);
	...
	public void testMediaImport() throws CSSException, IOException {
		CSSFactory.parse(getFile("/data/simple/impmedia.css"), null);
	}

	@Test
	public void testRealAndNested() throws CSSException, IOException {
		CSSFactory.parse(getFile("/data/abclinuxu/styles.css"), null);
	}
