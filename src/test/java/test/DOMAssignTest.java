...
import static test.DataUtil.getStream;
...
public class DOMAssignTest {
	...
	public static void init() throws SAXException, IOException {
		log.info("\n\n\n == DOMAssignTest test at {} == \n\n\n", new Date());
	}
	
	@Test
	public void basic() throws SAXException, IOException {	
		
        DOMSource ds = new DOMSource(getStream("/data/advanced/domassign.html"));
        Document doc = ds.parse();
        ElementMap elements = new ElementMap(doc);
        
		StyleMap decl = CSSFactory.assignDOM(doc,
				getUrl("/data/advanced/domassign.html"),"screen", true);
    ...
    public void structureSelectors() throws SAXException, IOException {  
        ...
        DOMSource ds = new DOMSource(getStream("/data/simple/selectors.html"));
        Document doc = ds.parse();
        ElementMap elements = new ElementMap(doc);
        
        StyleMap decl = CSSFactory.assignDOM(doc, null, getUrl("/data/simple/selectors.html"),"screen", true);
    ...
    public void indexSelectors() throws SAXException, IOException {  
        ...
        DOMSource ds = new DOMSource(getStream("/data/simple/selectors2.html"));
        Document doc = ds.parse();
        ElementMap elements = new ElementMap(doc);
        
        StyleMap decl = CSSFactory.assignDOM(doc, null, getUrl("/data/simple/selectors2.html"),"screen", true);
